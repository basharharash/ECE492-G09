...
def load_all_csv_files_separated(modified_dir='modified', window_size=5):
    ...
    quarter_folders = [os.path.join(modified_dir, q) for q in os.listdir(modified_dir) if os.path.isdir(os.path.join(modified_dir, q))]
    ...
    # Concatenate the windows from each file into single arrays
